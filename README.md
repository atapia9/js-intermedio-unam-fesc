...
- [Índice de todos los videos](documentos/videos.md), organizado por día y ficha, con los ejercicios donde se usa cada uno. Se regenera con `npm run indice` y el CI comprueba que esté al día; `npm run verificar-videos` comprueba que los enlaces sigan vivos (necesita internet)
